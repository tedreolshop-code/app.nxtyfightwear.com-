    ...
    <div className="space-y-6">
      ...
      {showAddForm && (
        <div className="fixed inset-0 z-50 bg-black/60 p-4 flex items-center justify-center no-print">
          <form onSubmit={handleCreateEmployee} className="bg-white rounded-2xl border border-gray-200 shadow-2xl w-full max-w-5xl max-h-[92dvh] overflow-y-auto overscroll-contain p-6 grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-6 space-y-5">
            ...
            <div className="bg-gray-50/50 p-4 rounded-xl border border-gray-100/80 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1">Bonus Kehadiran / Hari</label>
                  <div className="relative">
                    <span className="absolute left-2.5 top-2 text-[10px] text-gray-400 font-bold">Rp</span>
                    <input
                      type="number"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-gray-50 p-5 rounded-xl border border-gray-100 space-y-4">
                      ...
                      <div className="space-y-2.5 text-xs text-gray-600">
                        ...
                        <div>
                          <span className="text-gray-400 block text-[10px] uppercase font-bold tracking-wider">Bonus Kehadiran / Hari</span>
