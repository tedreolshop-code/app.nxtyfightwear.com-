  ...
  return <div className="space-y-4">
    ...
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
      <form onSubmit={createHandoff} className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
        <div><h3 className="font-black text-sm text-gray-900 flex items-center gap-2"><Send className="w-4 h-4 text-[#1F4B36]" /> Serahkan Hasil Kerja</h3><p className="text-[11px] text-gray-500">Catat hasil sebelum berpindah ke bagian berikutnya.</p></div>
        ...
        <button disabled={!jobId || !stageName || availableQty <= 0} className="w-full bg-[#1F4B36] disabled:bg-gray-300 text-white rounded-lg py-2.5 text-xs font-bold cursor-pointer disabled:cursor-not-allowed">Kirim Serah-Terima</button>
      </form>
